      ...
      <AnimatePresence>
        {open && (
          <motion.aside
            ...
            animate="show"
            exit="exit"
            className="fixed inset-x-3 bottom-40 z-40 flex max-h-[70vh] flex-col overflow-hidden holo-panel sm:inset-x-auto sm:bottom-24 sm:right-6 sm:h-[600px] sm:max-h-[calc(100vh-8rem)] sm:w-[400px]"
          >
